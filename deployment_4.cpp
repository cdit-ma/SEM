...
void Deployment_4::startup(){
        ...
        auto rxMessage = qpid::construct_RxMessage(receiver_impl, (std::bind(&ReceiverImpl::rxMessage, receiver_impl, std::placeholders::_1)), std::string("tcp://192.168.111.84:6000"));
        auto rxVectorMessage = qpid::construct_RxVectorMessage(receiver_impl2, (std::bind(&ReceiverImpl::rxVectorMessage, receiver_impl2, std::placeholders::_1)), std::string("tcp://192.168.111.84:6001"));
