...
public:
    ...
    AddLoganClient(std::unique_ptr<LoganClient> component, const std::string& id);
...
private:
    ...
    GetConfiguredWorker(std::shared_ptr<Component> component, const NodeManager::Worker& worker_pb);
    std::shared_ptr<Port>
    GetConfiguredPort(std::shared_ptr<Component> component, const NodeManager::Port& eventport_pb);
    ...
    ConstructPeriodicPort(std::weak_ptr<Component> component, const std::string& port_name);
    std::shared_ptr<Port> ConstructPublisherPort(const std::string& middleware,
                                                 const std::string& datatype,
                                                 std::weak_ptr<Component> component,
                                                 const std::string& port_name,
                                                 const std::string& namespace_str);
    std::shared_ptr<Port> ConstructSubscriberPort(const std::string& middleware,
                                                  const std::string& datatype,
                                                  std::weak_ptr<Component> component,
                                                  const std::string& port_name,
                                                  const std::string& namespace_str);

    std::shared_ptr<Port> ConstructRequesterPort(const std::string& middleware,
                                                 const std::string& datatype,
                                                 std::weak_ptr<Component> component,
                                                 const std::string& port_name,
                                                 const std::string& namespace_str);
    std::shared_ptr<Port> ConstructReplierPort(const std::string& middleware,
                                               const std::string& datatype,
                                               std::weak_ptr<Component> component,
                                               const std::string& port_name,
                                               const std::string& namespace_str);

    std::shared_ptr<Component> ConstructComponent(const std::string& component_type,
                                                  const std::string& component_name,
                                                  const std::string& namespace_str,
                                                  const std::string& component_id);

    // REVIEW (Mitch): These can be either static members or free functions.
    static std::string get_port_library_name(const std::string& port_type,
                                             const std::string& middleware,
                                             const std::string& namespace_name,
                                             const std::string& datatype);
    static std::string get_component_library_name(const std::string& component_type,
                                                  const std::string& namespace_name);
    ...
    std::vector<std::unique_ptr<re::NodeManager::Trigger>> triggers_;
