...
class Port{
    ...
    private:
        ...
        Middleware
        TranslateDefinitionMiddleware(Representation::MiddlewarePortInstance::Middleware middleware);
        Kind TranslateDefinitionKind(Representation::MiddlewarePortDefinition::Kind kind);
};
};
