...
void GraphMLController::view_updateGraphMLData(Node *node, QString key, QString value)
{
    ...
    updatedAction.itemKind = node->getKind();
    updatedAction.itemID = node->getID();
    updatedAction.srcID = "";
    updatedAction.dstID = "";
    updatedAction.removedXML = "";
