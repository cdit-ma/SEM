...
namespace Base {
	template <>
	std::unique_ptr<::Basic2> Translator<::Base::Basic2, ::Basic2>::BaseToMiddleware(const ::Base::Basic2& value){
		auto out = std::unique_ptr<::Basic2>(new ::Basic2());
	...
	template <>
	std::unique_ptr<::Base::Basic2> Translator<::Base::Basic2, ::Basic2>::MiddlewareToBase(const ::Basic2& value){
