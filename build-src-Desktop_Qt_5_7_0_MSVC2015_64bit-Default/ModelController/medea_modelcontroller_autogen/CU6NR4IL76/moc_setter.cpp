...
#include "../../../../src/ModelController/Entities/BehaviourDefinitions/setter.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_Setter_t, stringdata0) + ofs \
...
const QMetaObject Setter::staticMetaObject = {
    { &BehaviourNode::staticMetaObject, qt_meta_stringdata_Setter.data,
...
void *Setter::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Setter.stringdata0))
