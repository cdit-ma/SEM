...
#include "../../../../src/ModelController/Entities/InterfaceDefinitions/attribute.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_Attribute_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_Attribute_t qt_meta_stringdata_Attribute = {
    {
QT_MOC_LITERAL(0, 0, 9) // "Attribute"
...
const QMetaObject Attribute::staticMetaObject = {
    { &Node::staticMetaObject, qt_meta_stringdata_Attribute.data,
      qt_meta_data_Attribute,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *Attribute::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Attribute.stringdata0))
        return static_cast<void*>(const_cast< Attribute*>(this));
