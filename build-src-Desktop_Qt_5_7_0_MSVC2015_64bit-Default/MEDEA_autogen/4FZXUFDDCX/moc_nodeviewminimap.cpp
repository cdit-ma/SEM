...
QT_MOC_LITERAL(5, 48, 18), // "minimap_CenterView"
QT_MOC_LITERAL(6, 67, 16), // "viewport_changed"
QT_MOC_LITERAL(7, 84, 12), // "viewportRect"
QT_MOC_LITERAL(8, 97, 11) // "zoom_factor"

    },
    "NodeViewMinimap\0minimap_Pan\0\0delta\0"
    "minimap_Zoom\0minimap_CenterView\0"
    "viewport_changed\0viewportRect\0zoom_factor"
};
...
static const uint qt_meta_data_NodeViewMinimap[] = {
 ...
 // slots: parameters
    QMetaType::Void, QMetaType::QRectF, QMetaType::Double,    7,    8,
...
void NodeViewMinimap::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->minimap_CenterView(); break;
        case 3: _t->viewport_changed((*reinterpret_cast< QRectF(*)>(_a[1])),(*reinterpret_cast< double(*)>(_a[2]))); break;
        default: ;
        }
        ...
        {
            typedef void (NodeViewMinimap::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&NodeViewMinimap::minimap_CenterView)) {
                *result = 2;
                return;
            }
        }
...
const QMetaObject NodeViewMinimap::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_NodeViewMinimap.data,
...
// SIGNAL 2
void NodeViewMinimap::minimap_CenterView()
{
