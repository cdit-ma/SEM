/****************************************************************************
** Meta object code from reading C++ file 'docktitlebar.h'
**
...
#include "../../../src/Widgets/DockWidgets/docktitlebar.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'docktitlebar.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(3, 27, 17) // "updateActiveStyle"

    },
    "DockTitleBar\0themeChanged\0\0updateActiveStyle"
};
...
void DockTitleBar::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        DockTitleBar *_t = static_cast<DockTitleBar *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->themeChanged(); break;
        case 1: _t->updateActiveStyle(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObject DockTitleBar::staticMetaObject = {
    { &QToolBar::staticMetaObject, qt_meta_stringdata_DockTitleBar.data,
      qt_meta_data_DockTitleBar,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *DockTitleBar::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_DockTitleBar.stringdata0))
        return static_cast<void*>(const_cast< DockTitleBar*>(this));
