...
public:
    ...
    GetExperimentRuns(const AggServer::ExperimentRunRequest& request);
    std::unique_ptr<AggServer::ExperimentStateResponse>
    GetExperimentState(const AggServer::ExperimentStateRequest& request);
    std::unique_ptr<AggServer::PortLifecycleResponse>
    GetPortLifecycle(const AggServer::PortLifecycleRequest& request);
    std::unique_ptr<AggServer::WorkloadResponse>
    GetWorkload(const AggServer::WorkloadRequest& request);
    std::unique_ptr<AggServer::CPUUtilisationResponse>
    GetCPUUtilisation(const AggServer::CPUUtilisationRequest& request);
    std::unique_ptr<AggServer::MemoryUtilisationResponse>
    GetMemoryUtilisation(const AggServer::MemoryUtilisationRequest& request);
