 ...
 * @param parent
 */
ModelValidationDialog::ModelValidationDialog(QWidget *parent)
    : QDialog(parent)
{
...
void ModelValidationDialog::gotResults(QString reportPath)
{
...
void ModelValidationDialog::setupItemsTable(QStringList items)
{
...
void ModelValidationDialog::cellSelected(int nRow, int nCol)
{
    Q_UNUSED(nCol);
...
void ModelValidationDialog::revalidate()
{
    if(!spinning){
