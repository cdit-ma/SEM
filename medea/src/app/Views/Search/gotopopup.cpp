...
void GotoPopup::themeChanged()
{
	...
	search_completer->popup()->setStyleSheet(theme->getAbstractItemViewStyleSheet() % theme->getScrollBarStyleSheet() %
...
void GotoPopup::updateIDs(const QStringList& suggestions)
{
...
void GotoPopup::setupLayout()
{
	...
	search_bar->setValidator(new QIntValidator(this));
