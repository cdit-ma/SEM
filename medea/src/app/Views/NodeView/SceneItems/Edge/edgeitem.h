...
private:
    ...
    //Rectangle helpers
    QRectF getRect(const QPointF& center, const QSizeF& size) const;
    ...
    QSizeF centerCircleRectSize() const;
    QRectF translatedCenterCircleRect(const QPointF& center = QPointF()) const;
    
    QPointF getCenterCircleTermination(bool left, const QPointF& center = QPointF()) const;
    ...
    QPainterPath calculateArrowHead(const QPointF& endPoint, bool pointLeft) const;
