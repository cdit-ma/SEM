...
find_library(TAO_COS_TIME NAMES TAO_CosTime HINTS ${ACE_ROOT}/lib)
...
set(TAO_LIBRARIES ${TAO_LIBRARY} ${ACE_LIBRARY} ${TAO_PS_LIBRARY} ${TAO_ATC_LIBRARY} ${TAO_IOR_LIBRARY} ${TAO_MESSAGING_LIBRARY} ${TAO_COS_TIME} ${TAO_VALUE_TYPE})
 
message(${TAO_LIBRARIES})
