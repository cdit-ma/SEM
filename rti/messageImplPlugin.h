...
#ifndef messageImplPlugin_874241056_h
#define messageImplPlugin_874241056_h
...
*/
typedef  struct rti_test_dds_Message_c rti_test_dds_Message_cKeyHolder;

#define rti_test_dds_Message_cPlugin_get_sample PRESTypePluginDefaultEndpointData_getSample 
#define rti_test_dds_Message_cPlugin_get_buffer PRESTypePluginDefaultEndpointData_getBuffer 
#define rti_test_dds_Message_cPlugin_return_buffer PRESTypePluginDefaultEndpointData_returnBuffer 

#define rti_test_dds_Message_cPlugin_get_key PRESTypePluginDefaultEndpointData_getKey 
#define rti_test_dds_Message_cPlugin_return_key PRESTypePluginDefaultEndpointData_returnKey

#define rti_test_dds_Message_cPlugin_create_sample PRESTypePluginDefaultEndpointData_createSample 
#define rti_test_dds_Message_cPlugin_destroy_sample PRESTypePluginDefaultEndpointData_deleteSample 

/* --------------------------------------------------------------------------------------
Support functions:
* -------------------------------------------------------------------------------------- */

NDDSUSERDllExport extern rti_test_dds_Message_c*
...
rti_test_dds_Message_cPluginSupport_copy_data(
    rti_test_dds_Message_c *out,
    const rti_test_dds_Message_c *in);
...
NDDSUSERDllExport extern RTIBool
rti_test_dds_Message_cPlugin_skip(
    PRESTypePluginEndpointData endpoint_data,
    struct RTICdrStream *stream, 
...
rti_test_dds_Message_cPlugin_key_to_instance(
    PRESTypePluginEndpointData endpoint_data,
    rti_test_dds_Message_c *instance, 
    const rti_test_dds_Message_cKeyHolder *key);
...
rti_test_dds_Message_cPlugin_new(void);

NDDSUSERDllExport extern void
rti_test_dds_Message_cPlugin_delete(struct PRESTypePlugin *);
...
#endif /* messageImplPlugin_874241056_h */
