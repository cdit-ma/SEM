 ...
 *   . Included dhry_2.cpp (some inline issues)
...
/***********************************************************************
 * Execute Dhrystone loop a number of times                            *
 ***********************************************************************/
...
/* Default is bSilent=true, but we require this code to exist */
/* so that the compiler will not optimise any execution instructions */
if(!bSilent)
{ 
   printf ("\n");
...
if(!bSilent)
{
   ...
   printf ("  Ptr_Comp:       *    %d", (int) *((int*)(Next_Ptr_Glob->Ptr_Comp)));
...
/***********************************************************************
 * Execute number of MIP equivalent by Dhrystone loops                 *
 ***********************************************************************/
void dmip(int num, bool bSilent=true)
 /*****/
...
{ 
  ...
  Number_Of_Runs = num * 1757;
  if(!bSilent)
  {
     printf ("Execution starts, %d dmip executions\n", num);
  }// end bSilent
