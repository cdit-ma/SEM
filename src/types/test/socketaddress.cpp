...
TEST(sem_types_socketaddress, equality_operator)
{
...
TEST(sem_types_socketaddress, to_string)
{
...
TEST(sem_types_socketaddress, from_string)
{
    ...
    EXPECT_THROW(SocketAddress("192.168.111.230:"), std::invalid_argument);
    EXPECT_THROW(SocketAddress("192.168.111.230"), std::invalid_argument);
    EXPECT_THROW(SocketAddress("192.168.111.230:1111111111"), std::invalid_argument);
    EXPECT_THROW(SocketAddress("192.168.111.230:123invalid"), std::invalid_argument);
    EXPECT_THROW(SocketAddress("192.168.111.230:123 4"), std::invalid_argument);
}
} // namespace sem::types::test
#pragma warning(pop)
