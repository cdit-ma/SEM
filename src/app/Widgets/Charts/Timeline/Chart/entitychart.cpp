 ...
 * @param kind
 */
void EntityChart::removeEventSeries(TIMELINE_SERIES_KIND kind)
{
...
{
    MEDEA::EventSeries* _eventSeries = _seriesList.value(TIMELINE_SERIES_KIND::MEMORY_UTILISATION, 0);
       if (!_eventSeries)
            return;
