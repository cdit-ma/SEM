 ...
 * @param parent
 */
WorkloadEvent::WorkloadEvent(AggServerResponse::WorkerInstance inst, WorkloadEvent::WorkloadEventType type, quint32 workloadID, qint64 time, QString functionName, QString args, quint32 logLevel, QObject *parent)
