 ...
 * @param parent
 */
ContextToolbar::ContextToolbar(ViewController *vc, QWidget *parent) : QWidget(parent)
{
 ...
 */
void ContextToolbar::themeChanged()
{
 ...
 * @param itemPos
 */
void ContextToolbar::showToolbar(QPoint globalPos, QPointF itemPos)
{
    move(globalPos);
    setVisible(true);
 ...
 * @param visible
 */
void ContextToolbar::setVisible(bool visible)
{
    if (visible) {
 ...
 */
void ContextToolbar::populateDynamicMenu()
{
 ...
 * @param action
 */
void ContextToolbar::menuActionTrigged(QAction* action)
{
 ...
 * @param action
 */
void ContextToolbar::addChildNode(QAction* action)
{
 ...
 * @param action
 */
void ContextToolbar::addEdge(QAction *action)
{
    // ignore information actions
    if (!toolbarController || action->property("action-type") == "info") {
        return;
 ...
 * @param action
 */
void ContextToolbar::removeEdge(QAction *action)
{
    // ignore information actions
    if (!toolbarController || action->property("action-type") == "info") {
        return;
 ...
 */
void ContextToolbar::setupToolbar()
{
 ...
 */
void ContextToolbar::setupActions()
{
 ...
 */
void ContextToolbar::setupMenus()
{
    setupAddChildMenu();
    setupConnectMenu();
    setupDisconnectMenu();
 ...
 */
void ContextToolbar::setupSplitMenus()
{
    if (!actionController) {
        return;
    }
 ...
 */
void ContextToolbar::setupAddChildMenu()
{
 ...
 */
void ContextToolbar::setupConnectMenu()
{
 ...
 */
void ContextToolbar::setupDisconnectMenu()
{
 ...
 */
void ContextToolbar::setupConnections()
{
 ...
 */
void ContextToolbar::clearDynamicMenus()
{
    foreach (QMenu* menu, dynamicMenuKeyHash.keys()) {
        menu->clear();
    }
 ...
 * @return
 */
QMenu* ContextToolbar::constructTopMenu(QAction* parentAction, bool instantPopup)
{
   QMenu* menu = new QMenu(this);
 ...
 * @return
 */
QAction* ContextToolbar::getInfoAction(QString hashKey)
{
