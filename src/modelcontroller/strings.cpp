...
const QString KeyName::IconPrefix = "icon_prefix";
...
const QString KeyName::Namespace = "namespace";
const QString KeyName::Operation = "operation";
const QString KeyName::OuterType = "outer_type";
const QString KeyName::ReadOnly = "readOnly";
const QString KeyName::ReplicateCount = "replicate_count";
const QString KeyName::Row = "row";
