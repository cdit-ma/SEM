...
//enum Notification::Type{NT_NONE, NT_INFO, NT_WARNING, NT_ERROR, NT_CRITICAL};
...
enum VIEW_THEME{VT_NO_THEME, VT_LIGHT_THEME, VT_NORMAL_THEME, VT_DARK_THEME, VT_SOLARIZED_DARK_THEME, VT_SOLARIZED_LIGHT_THEME};
