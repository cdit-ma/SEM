...
enum VIEW_ASPECT{VA_NONE, VA_INTERFACES, VA_BEHAVIOUR, VA_ASSEMBLIES, VA_HARDWARE, VA_WORKERS};
...
enum ENTITY_KIND{EK_NODE, EK_EDGE};
...
extern QList<NOTIFICATION_TYPE> GET_NOTIFICATION_TYPES();
extern QString GET_NOTIFICATION_TYPE_COLORSTR(NOTIFICATION_TYPE type);
extern QString GET_NOTIFICATION_TYPE_STRING(NOTIFICATION_TYPE type);
